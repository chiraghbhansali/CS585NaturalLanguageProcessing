...
"""Calculate information-theoretic measures of distributional similarity based on word frequencies in two texts """
...
def js_divergence(p1, p2):
    ...
    m = {x: ((p1[x] + p2[x]) * 0.5) for x in p1 }
    js = (0.5 * (kl_divergence(p1,m) + kl_divergence(p2,m)))
    return js
